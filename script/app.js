...
const subjects = [
  ...
  },
  {
    name: "GBS103",
    semester: "semester1", // هنا الفصل الاول
    notes: "بما أن المادة تعتبر من المواد النظرية، فالحضور بسهل وبسرع عملية حفظ المعلومات وربطها، وذلك بحضور المحاضرات المسجلة للدكتورة غصون الأشقر أو د.زهير كنعان (فصول سابقة)، أو أي دكتور آخر، إضافة إلى دراسة ملفات ال PDF وحل أسئلة التشابترات.",             // كيف رح تدرس المادة
  ...
  },
  {
    name: "IPG101",
    semester: "semester1", // هنا الفصل الاول
    notes: "حضور المحاضرات المسجلة للدكتور الذي تفضّل شرحه (د.جهاد عيسى، د. وصال الأصفر، مروة خضور......) و بالإضافة لدراسة ملفات ال PDF والتطبيق العملي",             // كيف رح تدرس المادة
  ...
  },
  {
    name: "IIS201",
    semester: "semester2", // ← هنا الفصل الثاني
    notes: "تعتمد هذه المادة بنسبة 75% على الجانب العملي و 25% على النظري، لذا يعد حضور المحاضرات أمراً أساسياً. و د. أيهم محمد فصول سابقة ، د. وائل عبود ، د.هويدا الداوود، إضافة لدراسة ملفات PDF وحل اسئلة قنوات الاختبارات",             // كيف رح تدرس المادة
  ...
  //  الفصل الثالث
  {
    ...
    exam: "يتمّ امتحان مادة الإعداد الوظيفي بشكل مؤتمت، ويتكوّن من أسئلة نظرية تهدف إلى غياس فهم الطالب للمفاهيم والمصطلحات الأساسية الواردة في المقرر. يتضمّن الامتحان أسئلة من نوع الاختيار من متعدد، حيث تحتوي بعض الأسئلة على إجابة صحيحة واحدة، بينما تتطلب أخرى اختيار أكثر من إجابة صحيحة. يتراوح عدد الأسئلة عادة بين 25 و 30 سؤالاً، وقد يزيد في بعض الدورات حسب الخطة الامتحانية.",              // معلومات عن الامتحان
